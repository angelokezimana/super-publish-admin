...
<div class="container mb-2">
    <p class="h1 text-center">Modification de la publication '{{ $publication->title }}'</p>
...
<form action="{{ route('publications.update', $publication) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="text" id="title" name="title" placeholder="Entrez le titre" class="form-control form-control-sm" value="{{ old('title') ?? $publication->title }}">
        @error('title')
